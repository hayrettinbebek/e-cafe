...
namespace GridExtensions.GridFilters
{
	...
	public class DateGridFilter : GridFilterBase
	{
		...
		{
			if (_dateGridFilterControl.DateTimePicker1.Text.Length == 0)
				return "";
			if (_dateGridFilterControl.DateTimePicker2.Text.Length == 0)
				return "";

			if (_dateGridFilterControl.ComboBox.Text.Length == 0)
				return "";
