...
namespace GridExtensions.GridFilters
{
	...
	public class DistinctValuesGridFilter : GridFilterBase
	{
		...
		public DistinctValuesGridFilter(DataColumn column) : this(new ComboBox(), false) 
		{
			Fill(column);
		}
		...
		public DistinctValuesGridFilter(DataColumn column, ComboBox comboBox) : this(comboBox, true) 
		{
			Fill(column);
		}
