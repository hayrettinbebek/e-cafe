...
namespace GridExtensions
{
	...
	public class DataFilter
	{
		...
		static DataFilter()
		{
			_internalDataFilterType = typeof(DataTable).Assembly.GetType("System.Data.DataFilter");
			_constructorInfo = _internalDataFilterType.GetConstructor(BindingFlags.Public | BindingFlags.Instance, null, CallingConventions.Any, new Type[] { typeof(string), typeof(DataTable) }, null);
